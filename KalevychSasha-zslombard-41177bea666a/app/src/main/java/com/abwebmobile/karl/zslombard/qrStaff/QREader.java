...
import com.abwebmobile.karl.zslombard.allFragments.CameraChanger;
...
public class QREader {
  ...
  private final CameraChanger cameraChanger;
...
/*
  ...
  private QREader(final Builder builder) {
    ...
    this.cameraChanger = builder.cameraChanger;
  ...
  public void start() {
    if (surfaceView != null && surfaceHolderCallback != null) {
      ...
      if (surfaceCreated) {
        Log.d("qrDetails", "aurface created");
        startCameraView(context, cameraSource, surfaceView);
      }
      else {
        //startCameraView will be invoke in void surfaceCreated
        surfaceView.getHolder().addCallback(surfaceHolderCallback);
        Log.d("qrDetails", "surface not created");
      }
    }
  }
  ...
  private void startCameraView(Context context, CameraSource cameraSource,
    ...
    try {
      ...
      Log.d("QReader", "yeap this one "+ie.getMessage());
      ie.printStackTrace();

      cameraChanger.changeCamera(FRONT_CAM);
    }
  }
 ...
 *     the surface view
     ...
     */
    public Builder(CameraChanger cameraChanger, Context context, SurfaceView surfaceView, QRDataListener qrDataListener) {
